...
class Console
{
  public:
    ...
    template <typename... VA> static void Printf(std::string_view s, VA &&...va)
    {
    ...
    template <typename... VA> static void Printfln(std::string_view s, VA &&...va)
    {
        auto &console = GetInstance();
        auto str = std::vformat(s, std::make_format_args(std::forward<VA>(va)...));
        std::lock_guard lk(console.m_Lock);
    ...
    template <typename... VA> static void Printf(std::string_view ctrl_sequence, std::string_view s, VA &&...va)
    {
        auto &console = GetInstance();
        auto str = std::vformat(s, std::make_format_args(std::forward<VA>(va)...));
        std::lock_guard lk(console.m_Lock);
    ...
    template <typename... VA> static void Printfln(std::string_view ctrl_sequence, std::string_view s, VA &&...va)
    {
        auto &console = GetInstance();
        auto str = std::vformat(s, std::make_format_args(std::forward<VA>(va)...));
        std::lock_guard lk(console.m_Lock);
