...
\begin{figure}[H]
    \Centering
    \includegraphics[width=\textwidth]{docs/assets/about_recording}
    \caption{导出配置文件}
...
\begin{figure}[H]
    \Centering
    \includegraphics[width=\textwidth]{docs/assets/about_conventional_weapons}
...
\begin{figure}[H]
    \Centering
    \includegraphics[width=\textwidth]{docs/assets/weapons_for_previous_versions}
    \caption{“添加普通武器”和“添加定制武器”}
\end{figure}
