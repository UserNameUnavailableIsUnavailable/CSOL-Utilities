...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/close_controller.png}
%     \caption{关闭控制器}
% \end{figure}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/close_gamingtool.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/unlock_00.png}
%     \caption{点击“属性”}
% \end{figure}

% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/unlock_01.png}
%     \caption{解除锁定}
% \end{figure}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/extract_new_version.png}
%     \caption{解压新版本压缩包}
% \end{figure}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/replace_00.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/run_install.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/replace_01.png}
%     \caption{对比您的配置文件和新版样例配置文件}
% \end{figure}

% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/replace_02.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/replace_03.png}
%     \caption{替换配置文件}
% \end{figure}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/import_main_00.png}
%     \caption{点击“导入”}
% \end{figure}

% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/import_main_01.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/save_and_run_00.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/save_and_run_01.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/section_number_in_conf.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/run_new_gamingtool.png}
%     \caption{运行 \lstinline{GamingTool}}
% \end{figure}

% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/run_new_controller.png}
...
% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/config_new_positions_00.png}
%     \caption{配置新坐标}
% \end{figure}

% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/config_new_positions_01.png}
%     \caption{配置新坐标}
% \end{figure}

% \begin{figure}[H]
%     \Centering
%     \includegraphics[width=\textwidth]{documents/assets/update/config_new_positions_02.png}
%     \caption{配置新坐标}
% \end{figure}
...
对于武器列表，采用同样的方法，将旧版集成工具使用的 \lstinline{WeaponList.lua} 文件导入配置面板，然后导出（视自身需要进行修改）。导出时覆盖原有的 \lstinline{WeaponList.lua} 文件。如果需要，可以在浏览器中打开 \lstinline{Weapon.html} 进行武器配置。
