if not __AUTOMATION_LUA__ then
	...
	Include("core/Delay.lua")
	Include("core/Console.lua")
	Include("core/JSON.lua")
	Include("core/Context.lua")
	Include("core/Exception.lua")
	Include("core/Runtime.lua")
	Include("core/Keyboard.lua")
	Include("core/Mouse.lua")
	Include("core/DateTime.lua")
	Include("core/Command.lua")
	Include("core/Utility.lua")
	Include("core/Weapon.lua")
	Include("core/Player.lua")
	Include("core/Version.lua")
	
	-- custom modules
	Include("custom/Setting.lua")
	Include("custom/WeaponList.lua")
