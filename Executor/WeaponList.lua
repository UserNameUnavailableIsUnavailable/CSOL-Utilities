    ...
    ExtendedSpecialWeapons = {
        Weapon:new({
            ...
            use = function(self)
                ...
                if not self.discharging and current_time - self.charge_start_moment > self.RECHARGE_TIME then
                    self.discharging = true
                    self.discharge_start_moment = current_time
                    self:switch()
                    Mouse:click(Mouse.LEFT, Delay.LONG_LONG)
                elseif self.discharging and current_time - self.charge_start_moment > self.DISCHARGE_TIME then
