...
then
    ...
    function Interrupt:new(init)
        local interrupt = {}
        if (type(init) ~= "table" and type(init) ~= "function")
        then
            Error:throw{
        ...
        then
            ...
            if (type(init.name) ~= "string" and type(init.name) ~= "nil")
            then
                Error:throw{
            ...
            if (type(init.handler) ~= "function" and type(init.handler) ~= "nil")
            then
                Error:throw{
            ...
            if (type(init.parameters) ~= "table" and type(init.parameters) ~= "nil")
            then
                Error:throw{
