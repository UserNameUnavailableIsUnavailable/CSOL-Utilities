		...
		Weapon:new({
			...
			attack = function (self)
				...
				repeat					local current_time = Runtime:get_running_time()
					...
					Mouse:move_relative(math.ceil(direction * 100 * sensitivity_x / Setting.FIELD_IN_GAME_SENSITIVITY), math.ceil(math.sin(current_time / 1000) * 100 * sensitivity_y / Setting.FIELD_IN_GAME_SENSITIVITY), Delay.MINI)
